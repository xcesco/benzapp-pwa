...
export class NotificaComponent implements OnInit {
  ...
  trackId(index: number, item: INotifica): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: INotifica[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
